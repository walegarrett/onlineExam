...
<div class="error">
    <div class="container-floud">
        <div style="text-align: center">
            ...
            <h2 class="h1">很抱歉，您未登录，没有权限访问该页面！<a href="${APP_PATH}/login" target="_parent">点击登录</a>, <a href="${APP_PATH}/toAdminLogin" target="_parent">管理员登录</a></h2>
        </div>
        </div>
    </div>
</div>
...
<script>
    ...
    loop3 = setInterval(function () {
        if (i > 40) {
            clearInterval(loop3);
            document.querySelector('.thirdDigit').textContent = "未";
        } else {
    ...
    loop2 = setInterval(function () {
        if (i > 80) {
            clearInterval(loop2);
            document.querySelector('.secondDigit').textContent = "登";
        } else {
    ...
    loop1 = setInterval(function () {
        if (i > 100) {
            clearInterval(loop1);
            document.querySelector('.firstDigit').textContent = "录";
        } else {
